...
from model import PNA_model, SAGE_lut
...
def main():
    ...
    old_train_path = r'./train_lut.py'
    new_train_path = os.path.join(args.save_path,'train_lut.py')
    ...
    model = SAGE_lut(in_channels = 11, hidden_channels = 32, out_channels = 128)
    #model = PNA_model()
