...
sys.path.append("..")
import torch
from train_atheta.model_con import PNA_con, PNA_con2
import argparse
...
def main():
    ...
    parser.add_argument('--save_path', dest = 'save_path',default = './test_results/test_con/')
    parser.add_argument('--proxy_path', dest = 'proxy_path',default = '../train_proxy/train_files/con/train_con_100lr0001/')
    parser.add_argument('--model_path', dest = 'model_path',default = '../train_atheta/train_files/con/train_a_con_51lr0001/')
    ...
    #load the optimizer
    optimizer = PNA_con2(args.gpu, args.model_path)
    ...
    #load the predictor
    predictor = PNA_con(args.gpu, args.proxy_path)
