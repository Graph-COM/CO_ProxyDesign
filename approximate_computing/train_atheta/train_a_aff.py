...
from model_aff import PNA_aff2, PNA_aff
...
def main():
    ...
    parser.add_argument('--proxy_path', dest = 'proxy_path',default = '../train_proxy/train_files/aff/train_aff_100lr0001/best_val_model.pth')
    ...
    old_train_path = r'./train_a_aff.py'
    new_train_path = os.path.join(args.save_path,'train_a_aff.py')
    ...
    model = PNA_aff2(args.gpu, args.save_path)
    model.to(device)
    optimizer = torch.optim.Adam(model.parameters(), lr = 0.001)

    proxy = PNA_aff(args.gpu, args.save_path)
